...
import { MaintenanceProfileReactiveForm1Business } from './maintenance-profile-reactive-form1.business';

@Component({
  selector: 'maintenance-profile-reactive-form1',
  templateUrl: './maintenance-profile-reactive-form1.component.html',
  styleUrls: ['./maintenance-profile-reactive-form1.component.less'],
  providers: [MaintenanceProfileReactiveForm1Business],
})
export class MaintenanceProfileReactiveForm1Component
  ...
  implements OnInit
{
  ...
  constructor(
    protected override _business: MaintenanceProfileReactiveForm1Business,
