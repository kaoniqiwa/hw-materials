...
import { GarbageProfileReactiveCamerasBusiness } from './garbage-profile-reactive-cameras.business';

@Component({
  selector: 'garbage-profile-reactive-cameras',
  templateUrl: './garbage-profile-reactive-cameras.component.html',
  styleUrls: ['./garbage-profile-reactive-cameras.component.less'],
  providers: [GarbageProfileReactiveCamerasBusiness],
})
export class GarbageProfileReactiveCameras implements OnInit, OnChanges {
  @Input()
  formId?: string;
  ...
  constructor(
    ...
    private _business: GarbageProfileReactiveCamerasBusiness,
