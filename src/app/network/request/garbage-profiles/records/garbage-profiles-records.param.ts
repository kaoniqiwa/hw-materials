...
export class GetModificationRecordsParams extends PagedDurationParams {
  /**	String[]	档案ID	O	*/ ProfileIds?: string[];
  /**	Int32	档案类型	O	*/ ProfileType?: number;
  /**	String	档案名称，LIKE	O	*/ ProfileName?: string;
  /**	String	修改原因，LIKE	O	*/ ModificationReason?: string;
  /**	String	修改内容，LIKE	O	*/ ModificationContent?: string;
...
export class GetMaterialRecordsParams extends PagedDurationParams {
  /**	Int32	记录类型	O	*/ MaterialRecordType?: MaterialRecordType;
  /**	String[]	档案ID	O	*/ ProfileIds?: string[];
  /**	String	档案名称,LIKE	O	*/ ProfileName?: string;
